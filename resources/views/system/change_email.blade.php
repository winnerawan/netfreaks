...
<div id="page_master_user_admin">
    <div class="panel">
        <div class="panel-heading">
            ...
            &nbsp;
            &nbsp;
            EDIT {{ strtoupper($user->name) }} EMAIL
        </div>
        <div class="panel-body">
            <form method="post" action="{{ route('system.changeEmailPost') }}" accept-charset="UTF-8"
                autocomplete="off">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input required type="email" name="email" class="form-control" value="{{old('name', $user->email)}}">
                        </div>
                    </div>
                </div>
